...
impl<S: OpenRGBStream> OpenRGB<S> {
    ...
    pub async fn get_controller_count(&self) -> Result<u32, OpenRgbError> {
        self.stream
            .lock()
            .await
            .request(self.protocol, 0, PacketId::RequestControllerCount, ())
            .await
    }
    ...
    pub async fn get_profiles(&self) -> Result<Vec<String>, OpenRgbError> {
        ...
        self.stream
            .lock()
            .await
            .request::<_, (u32, Vec<String>)>(self.protocol, 0, PacketId::RequestProfileList, ())
            .await
    ...
    pub async fn save_profile(&self, name: impl Into<String>) -> Result<(), OpenRgbError> {
        ...
        self.stream
            .lock()
            .await
            .write_packet(self.protocol, 0, PacketId::RequestSaveProfile, name.into())
            .await
    }
